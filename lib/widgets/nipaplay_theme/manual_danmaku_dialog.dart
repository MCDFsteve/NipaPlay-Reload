...
class _ManualDanmakuMatchDialogState extends State<ManualDanmakuMatchDialog>
  ...
  Future<List<Map<String, dynamic>>> _searchAnime(String keyword) async {
    ...
    try {
      ...
      final url =
          'https://api.dandanplay.net/api/v2/search/anime?keyword=${Uri.encodeComponent(keyword)}';
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: TextStyle(color: _foregroundColor(context), fontSize: 13),
          decoration: InputDecoration(
            hintText: '动画名称',
            hintStyle:
                TextStyle(color: _foregroundColor(context, 0.6), fontSize: 12),
            isDense: true,
            contentPadding:
            ...
            focusedBorder: OutlineInputBorder(
              borderSide: BorderSide(color: _foregroundColor(context, 0.6)),
              borderRadius: BorderRadius.circular(6),
            ),
          ),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              side: BorderSide(color: _foregroundColor(context, 0.3)),
              ...
              children: [
                ...
                TextButton.icon(
                  icon: Icon(Icons.arrow_back,
                      size: 16, color: _foregroundColor(context, 0.7)),
                  label: Text('返回',
                      style: TextStyle(
                          fontSize: 12, color: _foregroundColor(context, 0.7))),
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: '输入动画名称搜索',
                      hintStyle:
                          TextStyle(color: _foregroundColor(context, 0.6)),
                      isDense: true,
                      border: OutlineInputBorder(
                        borderSide:
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide:
                            BorderSide(color: _foregroundColor(context, 0.6)),
                      ),
                    ),
                    onSubmitted: (_) => _performSearch(),
                  ),
                  ...
                  child: TextButton.icon(
                    ...
                    style: TextButton.styleFrom(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 8, vertical: 4),
                      minimumSize: const Size(0, 32),
                      backgroundColor: _foregroundColor(context, 0.1),
                    ),
                  ),
                ),
              ],
                        ...
                        children: [
                          if (_showEpisodesView) ...[
                            TextButton(
                              onPressed: _backToAnimeSelection,
                              style: TextButton.styleFrom(
                                foregroundColor: _foregroundColor(context, 0.7),
                                padding: const EdgeInsets.symmetric(
