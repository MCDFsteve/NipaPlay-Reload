...
class CupertinoSeekStepSheet extends StatefulWidget {
  const CupertinoSeekStepSheet({
    super.key,
  ...
  @override
  State<CupertinoSeekStepSheet> createState() =>
      _CupertinoSeekStepSheetState();
}

class _CupertinoSeekStepSheetState extends State<CupertinoSeekStepSheet> {
