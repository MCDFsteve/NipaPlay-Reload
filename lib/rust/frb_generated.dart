...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1992356526;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'flutter_bridge',
    ioDirectory: 'rust/flutter_bridge/target/release/',
    webPrefix: 'pkg/',
  );
}

abstract class RustLibApi extends BaseApi {
  Future<int> crateApiBufferedPositionMs();

  Future<int> crateApiDurationMs();

  Future<void> crateApiInit();

  Future<void> crateApiLoad({required String url});

  Future<void> crateApiPause();

  Future<void> crateApiPlay();

  Future<int> crateApiPositionMs();

  Future<void> crateApiSeek({required int positionMs});

  Future<void> crateApiSetPlaybackRate({required double rate});

  Future<void> crateApiSetVolume({required double volume});

  Future<void> crateApiStop();

  Future<VideoFrame?> crateApiTryPullFrame();
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<int> crateApiBufferedPositionMs() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiBufferedPositionMsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBufferedPositionMsConstMeta => const TaskConstMeta(
        debugName: "buffered_position_ms",
        argNames: [],
      );
  ...
  Future<int> crateApiDurationMs() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiDurationMsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDurationMsConstMeta => const TaskConstMeta(
        debugName: "duration_ms",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiLoadConstMeta => const TaskConstMeta(
        debugName: "load",
        argNames: ["url"],
      );
  ...
  Future<int> crateApiPositionMs() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPositionMsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPositionMsConstMeta => const TaskConstMeta(
        debugName: "position_ms",
        argNames: [],
      );
  ...
  Future<void> crateApiSetPlaybackRate({required double rate}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSetPlaybackRateConstMeta,
      argValues: [rate],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSetPlaybackRateConstMeta => const TaskConstMeta(
        debugName: "set_playback_rate",
        argNames: ["rate"],
      );
  ...
  Future<VideoFrame?> crateApiTryPullFrame() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTryPullFrameConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTryPullFrameConstMeta => const TaskConstMeta(
        debugName: "try_pull_frame",
        argNames: [],
      );
  ...
  void sse_encode_box_autoadd_video_frame(
      VideoFrame self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
